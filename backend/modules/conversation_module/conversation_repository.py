...
class ConversationRepository:
    ...
    def get_by_phone(self, tenant_id: str, phone: str, instance_name: str = None) -> Optional[Dict[str, Any]]:
        return supabase_svc.get_conversation_by_phone(tenant_id, phone, instance_name)
    ...
    def create(self, tenant_id: str, phone: str, channel: str = "whatsapp", lead_id: str = None, instance_name: str = None) -> Dict[str, Any]:
    ...
    def delete_all(self, tenant_id: str) -> bool:
        return supabase_svc.delete_all_conversations(tenant_id)

    def delete_by_id(self, conversation_id: str) -> bool:
        return supabase_svc.delete_conversation_by_id(conversation_id)
